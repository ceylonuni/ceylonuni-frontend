    ...
    <div className="flex justify-center items-center min-h-screen">
      <div className="flex flex-col justify-center items-center px-10 md:mt-0 mt-12">
        ...
        <p className="text-xl font-medium text-gray-500 px-5 mt-5 max-w-lg text-center">
          A verification link has been sent to <b className="text-green-500">example@course.uni.lk</b>. Click that link to verify your email and registr to <b className="text-teal-500">ceylonuni.lk</b>.
        </p>
      </div>
    </div>
  );
